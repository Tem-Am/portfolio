...
export default function Home() {
  return (
    <section >
      <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-violet-50 via-purple-50 to-pink-50">
          ...
          <div className="max-w-4xl mt-12 mx-auto text-center">
            <div>
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
                ...
                infrastructure that make technology more efficient and
                accessible.
              </p>
